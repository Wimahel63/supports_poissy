...
// application l'evenement click à chaque option :il declenche le remplissage automatique des champs

//  for(var i=1;i<document.querySelectorAll("#nomClientD option").length;i++){

//      document.querySelectorAll("#nomClientD option")[i].addEventListener("click",

//       function (){
 
//       var j =document.querySelectorAll("#nomClientD option")[i].innerHTML;
...
function qteproduit1(){
   ...
   function qteproduit2(){
      ...
      document.getElementById("stotal").innerHTML=parseFloat(document.getElementById("prixht").innerHTML)+ 
      parseFloat(document.getElementById("prixht1").innerHTML)+document.getElementById("prixht2").innerHTML;
